...
const CFG = {
    ...
    cake: {
        ...
        imageScale: {
            cake: 1.0,      // 蛋糕本体
            candle: 0.26,   // 未点燃的蜡烛（细长）
            fire: 0.30,     // 点燃的蜡烛（带火焰）
            note: 0.55,     // 便签
            match: 0.5,     // 火柴（长条）
        },
        candleBaseRatio: 0.7,  // 蜡烛底端在蛋糕高度上的位置（0.88≈贴着蛋糕顶面）
...
function drawResetSign() {
    ...
    textAlign(CENTER, CENTER);
    textSize(23);
    text('好好长大，按时吃饭/n/n这是一份粗糙不过的礼物，只是因为希望换个表达的形式，所以选择了这种/n/n东西做的不好，但话都是真心的，用垃圾包住真话，我觉得表达更加自然/n/n一份不成熟的作品，一颗真心哦/n/n生日快乐！', 0, 2);
    // 小星星点缀
